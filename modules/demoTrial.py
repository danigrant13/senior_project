...
You will see a series of faces in this game. These faces are previous participants who currently attend CU Boulder. 
Based on your results, you may be asked in the future to be paired with these participants in future studies.
"""

beginWithGame1 = "First, we will describe Game #1"

pressSpace = "Press the SPACE key to continue reading the instructions."

summaryText = """
In Game #1, you will be presented with a steady stream of letters at the center of the screen \
...
1. Press the SHIFT key when the letter at the center of the screen is a VOWEL.
       (i.e. press SHIFT when the letter 'a' appears, but not the letter 'f')
...
1. Not every trial of the experiment will have an image change, some will 
